      ...
      {loading ? (
        ...
        <ul className="flex flex-col items-center mt-2">
          {blog.map(item => (
            <li key={item._id}>
              <div className='card-item'>
                <div className="block justify-center p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                  <div className="flex items-center space-x-4">
                    <img
                      className="w-12 h-12 rounded-full object-cover"
                      src="https://via.placeholder.com/150"
